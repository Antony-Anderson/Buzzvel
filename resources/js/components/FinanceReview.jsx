  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      <div className="flex items-center gap-2 text-[10px] font-bold text-brand-text-muted/80 tracking-widest uppercase">
        <span onClick={onCancel} className="cursor-pointer hover:text-brand-foreground transition">
          Finance Review
        </span>
        <span>&gt;</span>
        <span className="text-brand-accent">Request #BZ-90{request.id}</span>
      </div>

      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <h1 className="text-3xl font-extrabold tracking-tight text-brand-foreground uppercase">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-5">
          <div className="bg-brand-card border border-brand-border/60 rounded-xl p-6 space-y-6 shadow-xl">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pb-6 border-b border-brand-border/30">
              <div>
                <span className="text-[9px] font-bold tracking-widest text-brand-accent uppercase">Requesting User</span>
                <div className="flex items-center gap-3 mt-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-brand-foreground">{request.user?.name || 'Unknown User'}</p>
              ...
              <div>
                <span className="text-[9px] font-bold tracking-widest text-brand-accent uppercase">Timestamp</span>
                <div className="flex items-center gap-3 mt-4">
                  <div className="w-8 h-8 rounded-lg bg-brand-inset border border-brand-border/40 flex items-center justify-center text-brand-text-muted">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <div>
                    <p className="text-xs font-semibold text-brand-foreground">{timestampStr}</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 py-2">
              <div>
                ...
                <p className="text-2xl font-black text-brand-foreground mt-1.5">
              ...
              <div>
                ...
                <div className="flex items-center gap-1.5 mt-2.5">
                  <p className="text-xs font-bold text-brand-foreground">{parseFloat(request.exchange_rate).toFixed(4)}</p>
              ...
              <div>
                ...
                <p className="text-xs font-semibold text-brand-foreground mt-2.5">External Vendor</p>
              </div>
            </div>

            <div className="pt-6 border-t border-brand-border/30 space-y-2">
              <span className="text-[9px] font-bold tracking-widest text-brand-accent uppercase">Request Justification</span>
        ...
        <div className="space-y-5">
          <div className="bg-brand-card border border-brand-border/60 rounded-xl p-6 space-y-6 shadow-xl relative overflow-hidden">
            <h3 className="text-sm font-bold text-brand-foreground uppercase tracking-wider">Decision Terminal</h3>
            ...
            {request.status === 'pending' ? (
              <div className="space-y-4">
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-brand-input border border-brand-border/60 hover:border-brand-border focus:border-brand-coral/50 rounded-lg p-2.5 text-xs text-brand-foreground placeholder-brand-text-muted/40 outline-none resize-none transition"
                  ></textarea>
                </div>
                ...
                <div className="space-y-2.5 pt-2">
                  <button
                    ...
                    disabled={submitting}
                    className="w-full bg-brand-approve border border-transparent hover:bg-brand-surface text-brand-contrast py-2.5 px-4 rounded-lg font-bold text-xs flex items-center justify-center gap-1.5 transition duration-200 cursor-pointer shadow-lg shadow-brand-coral/5 glow-coral-sm uppercase disabled:opacity-50"
                  >
                  ...
                  <button
                    ...
                    disabled={submitting}
                    className="w-full bg-brand-danger-bg border border-brand-border/60 hover:border-brand-border text-red-400 hover:text-red-300 py-2.5 px-4 rounded-lg font-bold text-xs flex items-center justify-center gap-1.5 transition duration-200 cursor-pointer uppercase disabled:opacity-50"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="p-3.5 bg-brand-inset border border-brand-border/40 rounded-lg flex gap-2.5">
              ...
              <div className="text-center py-6 text-brand-text-muted bg-brand-inset border border-brand-border/40 rounded-lg text-xs font-semibold">
          ...
          <div className="bg-brand-card border border-brand-border/60 rounded-xl p-5 space-y-4">
            <h4 className="text-xs font-bold text-brand-foreground uppercase tracking-wider">Recent Activity</h4>
            ...
            <div className="relative pl-6 border-l border-brand-border/80 space-y-5 text-xs py-1">
              <div className="relative">
                ...
                <p className="font-semibold text-brand-foreground">Request Created</p>
              ...
              <div className="relative">
                ...
                <p className="font-semibold text-brand-foreground">{timelineNodeTitle}</p>
