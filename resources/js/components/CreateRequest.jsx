...
export default function CreateRequest({ token, exchangeRates, addToast, onCancel, onSuccess }) {
  ...
  // Live estimate conversion when inputs change
  useEffect(() => {
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full bg-brand-input border border-brand-border/60 hover:border-brand-border focus:border-brand-coral/50 rounded-lg py-2.5 px-3.5 text-xs text-white outline-none cursor-pointer appearance-none transition"
                  >
        ...
        <div className="space-y-5">
          ...
          <div className="bg-brand-card border border-red-500/20 rounded-xl p-5 relative overflow-hidden">
            ...
            <div className="flex items-center gap-2.5 text-brand-coral mb-3">
              ...
              <h4 class="text-xs font-bold uppercase tracking-wider">48h Expiration</h4>
            </div>
